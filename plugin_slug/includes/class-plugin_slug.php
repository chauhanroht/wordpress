...
class Plugin_slug {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Plugin_slug_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Plugin_slug_Loader. Orchestrates the hooks of the plugin.
	 * - Plugin_slug_i18n. Defines internationalization functionality.
	 * - Plugin_slug_Admin. Defines all hooks for the admin area.
	 * - Plugin_slug_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Plugin_slug_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		//Add a sub menu to settings
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'plugin_slug_setup_menu' );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_loaded', $plugin_public, 'plugin_slug_test' );

		//Add short code
		$this->loader->add_shortcode('shortcode_test', $plugin_public, 'shortcode_test');
